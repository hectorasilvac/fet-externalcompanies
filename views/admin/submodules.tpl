    ...
    <div class="br-pagebody mg-t-3 pd-x-30">
        <div class="br-section-wrapper mn-ht-120 panel">
            ...
            <div class="ft-right">
                ...
                {if $act_add}
                <button type="button" id="btn_select_actions_table" data-flag="0" class="btn btn-primary ml-1 d-none" data-toggle="tooltip" data-placement="top" title="Marcar todos">
                    <i class="fas fa-exchange-alt"></i>
                </button>
                {/if}
                {if $act_change}
                <button type="button" id="btn_select_actions_table_change" data-flag="0" class="btn btn-primary ml-1 d-none" data-toggle="tooltip" data-placement="top" title="Marcar todos">
                    <i class="fas fa-exchange-alt"></i>
                </button>
                {/if}
            </div>
                    ...
                    <table id="default_table" class="table table-hover tb-responsive wd-100p-force">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-20p-force p-2">Submodulo</th>
                                <th class="wd-20p-force p-2">Significado</th>
                                <th class="wd-20p-force p-2">URL</th>
                                <th class="wd-20p-force p-2">Módulo</th>
                                {if $act_change or $act_trace}
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="form-group pos-relative">
                                    ...
                                    <input class="form-control" type="text" id="name_submodule" name="name_submodule" placeholder="Ingresa el submodulo" autocomplete="false"  autofocus="true">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group pos-relative">
                                    <label class="form-control-label">Significado:</label>
                                    <input class="form-control" type="text" id="name_es_submodule" name="name_es_submodule" placeholder="Ingresa el significado del submodulo" autocomplete="false">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group pos-relative">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group pos-relative">
                                    ...
                                    <input class="form-control" type="text" id="url_submodule" name="url_submodule" placeholder="Ingresa la URL" autocomplete="false">
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div id="view_form_add_action" class="mg-t-60 d-none">
                <div class="form-layout">
                    <div class="row mg-b-25">
                        <input type="hidden" id="submodule_add" name="id_submodule_actions">
                        <div class="col-lg-12">
                            {if $mobile}<br/><br/><br/>{/if}
                            <div class="table-wrapper">
                                <table id="actions_table" class="table table-hover tb-responsive wd-100p-force">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-10p-force p-2">Estado</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div>
                        <button id="btn_cancel_add_action" class="btn btn-secondary">Cerrar</button>
                    </div>
                </div>
            </div>
            {/if}
            {if $act_change}
            <div id="view_form_change" class="mg-t-60 d-none">
                <div class="form-layout">
                    <div class="row mg-b-25">
                        <div class="col-lg-12">
                            <div class="table-wrapper">
                                <input type="hidden" id="submodule_change" name="id_submodule_actions">
                                <table id="actions_table_change" class="table table-hover tb-responsive wd-100p-force">
                                    <thead>
                                        <tr>
                                            {if !$mobile}<th class="wd-10p-force p-2">No</th>{/if}
                                            <th class="wd-80p-force p-2">Acciones</th>
                    ...
                    <div>
                        <button id="btn_cancel_change" class="btn btn-secondary">Cerrar</button>
                    </div>
                </div>
            </div>
            {/if}
...
<footer class="br-footer">
    <div class="footer-left">
        <div class="mg-b-2 tx-gray-800">{$COPYRIGHT}
</footer>
{if $act_trace}
...
{block name='scripts'}
    <script type="text/javascript">
        ...
        var $path_update_state_action                                           =   '{$path_update_state_action}';
        var $path_update_actions_all                                            =   '{$path_update_actions_all}';
        ...
        var act_change                                                          =   '{$act_change}';
        var act_trace                                                           =   '{$act_trace}';
    </script>
    {if $mobile}
        <script src="{$RESOURCES}js/mobile/submodules.js"></script>
    {else}
        <script src="{$RESOURCES}js/desktop/submodules.js"></script>
    {/if}    
{/block}