...
class Users_model extends CI_Model
{
    ...
    * @return    array $result
    **/
    public function aspirants_select($params)
    {
        $result                                                                 =   array();
        ...
        $this->db->select('id_aspirant AS id, CONCAT(name_aspirant, " ", first_last_name_aspirant, " ", second_last_name_aspirant) AS text');
        $this->db->where('flag_drop', 0);

        if (isset($params['q']) && $params['q'] != '')
        {
            $this->db->like('CONCAT(name_aspirant, " ", first_last_name_aspirant, " ", second_last_name_aspirant)', $params['q']);
        }

        $this->db->order_by('name_aspirant', 'asc');
        $this->db->limit($limit, $start);
    ...
    * @return    array $result
    **/
    public function exist_user($params)
    {
        $result                                                                 =   array();
    ...
    * @return    array $result
    **/
    public function role_in_user($params)
    {
    ...
    * @return    array $result
    **/
    public function user_flags($param)
    {
        $result                                                                 =   array();
    ...
    * @return    array $result
    **/
    public function edit_flags($params)
    {
        $result                                                                 =   array();
        ...
        if ($state == '1')
        {
            ...
            $answer                                                             =   $this->_trabajandofet_model->insert_data($params, 'git_users_flags');
        }
        else
        {
            $answer                                                             =   $this->_trabajandofet_model->drop_data($params, 'git_users_flags');
        }
    ...
    **/
    public function display($params)
    {
        ...
        {
            $result['data']                                                     =   FALSE;
            $result['message']                                                  =   'Problemas al ' .(( $params['display'] == 0 ) ? 'inhabilitar' : 'habilitar'). ' el usuario.';
        }
