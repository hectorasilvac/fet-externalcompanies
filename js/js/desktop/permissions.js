    ...
    $('#default_table').DataTable(
    {
        ...
        [
            ...
            },
            {
                ...
                render: function(data, type, row)
                {
                    return '<div class="span-left">' + data + '</div>';
                }
            },
            {
                targets: [2],
            ...
            },
            {
                ...
                render: function(data, type, row)
                {
                    ...
                    if (act_drop)
                    {
                        content += '<a data-toggle="tooltip" data-placement="top" title="Eliminar" href="javascript:void(0)" class="remove-row pd-x-5-force" data-role="' + row.id_role + '" data-submodule="' + row.id_submodule + '" data-action="' + row.id_action + '"><i class="fas fa-trash-alt"></i></a>';
                    }

                    if (act_trace)
                    {
                        content += '<a data-toggle="tooltip" data-placement="top" title="Trazabilidad" href="javascript:void(0)" class="pd-x-5-force" onclick="trace(\'' + $path_trace + '\', \'ids\',\'' + row.id_role + '-' + row.id_submodule + '-' + row.id_action + '\')"><i class="fas fa-history"></i></a>';
                    }
        ...
        if (id_role_continue != null && id_submodule_continue != null)
        {
            ...
            $('#actions_table_continue').DataTable(
            {
                ...
                ajax:
                {
                    ...
                    data:
                    {
                        id_submodule:   id_submodule_continue
                    }
                },
                columnDefs:
                [
