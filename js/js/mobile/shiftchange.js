...
function shiftchange_datatable(height)
{
    $('#loading').removeClass('d-none');
    ...
    $('#default_table').DataTable(
    {
        ...
        {
            data.length = 50;
            data.shiftchange_state = $('#shiftchange_state').val();
            data.shiftchange_coordinator = $('#shiftchange_coordinator').val();
        ...
        [
            {
                ...
                {
                   $(td).attr('data-label', 'Trabajador solicitante');
                },
                render: function(data, type, row)
                {
                    ...
                    return '<br><br><div class="span-center"><span>' + data + profession_aa + '<br><b>Turno de cambio: </b>' + row.type_shiftchange + '</span></div>';
                }
            },
            {
                targets: [1],
                ...
                createdCell:  function(td, cellData, rowData, row, col)
                {
                   $(td).attr('data-label', 'Fecha de cambio');
                },
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-center"><span>' + data + '</span></div>';
                }
            },
            {
                targets: [2],
                ...
                createdCell:  function(td, cellData, rowData, row, col)
                {
                   $(td).attr('data-label', 'Trabajador de reemplazo');
                },
                render: function(data, type, row)
                {
                    var profession_ar = '';
                    ...
                    return '<br><br><div class="span-center"><span>' + data + profession_ar + '<br><b>TURNO DE REEMPLAZO: </b>' + row.type_return_shiftchange + '</span></div>';
                }
            },
            {
                targets: [3],
                ...
                createdCell:  function(td, cellData, rowData, row, col)
                {
                   $(td).attr('data-label', 'Fecha de reemplazo');
                },
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-center"><span>' + data + '</span></div>';
