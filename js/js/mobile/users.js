        ...
        [
            {
                ...
                {
                    return '<br><br><div class="span-left"><span data-name="name_user" data-type="text" data-pk="' + row.id_user + '" data-url="' + $path_edit + '">' + data + '</span><br>'
                    + '<span data-name="lastname_user" data-type="text" data-pk="' + row.id_user + '" data-url="' + $path_edit + '">' + row.lastname_user + '</span></div>';
                }
            },
            {
                targets: [1],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span data-name="id_role" data-type="select2" data-pk="' + row.id_user + '" data-url="' + $path_edit + '" data-value="' + row.id_role + '">' + data + '</span></div>';
                }
            },
            {
                targets: [2],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span data-name="user" data-type="text" data-pk="' + row.id_user + '" data-url="' + $path_edit + '">' + data + '</span></div>';
                }
            },
            {
                targets: [3],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span data-name="email_user" data-type="text" data-pk="' + row.id_user + '" data-url="' + $path_edit + '">' + data + '</span></div>';
                }
            },
            {
                targets: [4],
                ...
                createdCell:  function(td, cellData, rowData, row, col)
                {
                   $(td).attr('data-label', 'Último ingreso');
                },
                render: function(data, type, row)
                {
                    ...
                    return '<br><br><div class="span-left">' + html + '</div>';
                }
            },
            {
                targets: [5],
