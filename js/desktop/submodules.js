    ...
    $('#default_table').DataTable(
    {
        ...
        [
            ...
            },
            {
                ...
                render: function(data, type, row)
                {
                    return '<span id="name_submodule" data-type="text" data-pk="' + row.id_submodule + '" data-url="' + $path_edit + '">' + data + '</span>';
                }
            },
            {
                targets: [2],
                ...
                render: function(data, type, row)
                {
                    return '<span id="name_es_submodule" data-type="text" data-pk="' + row.id_submodule + '" data-url="' + $path_edit + '">' + data + '</span>';
                }
            },
            {
                targets: [3],
                ...
                render: function(data, type, row)
                {
                    return '<span id="url_submodule" data-type="text" data-pk="' + row.id_submodule + '" data-url="' + $path_edit + '">' + data + '</span>';
                }
            },
            {
                targets: [4],
                ...
                render: function(data, type, row)
                {
                    return '<span id="id_module" data-type="select2" data-pk="' + row.id_submodule + '" data-url="' + $path_edit + '" data-value="' + row.id_module + '">' + data + '</span>';
                }
            },
            {
                targets: [5],
