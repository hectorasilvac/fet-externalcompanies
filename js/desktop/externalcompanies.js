  ...
  $("select[name='city_cv_ec']")
    .select2({
      ...
      ajax: {
        ...
        delay: 250,
        data: function (params) {
          var department = $("select[name='department_cv_ec'] option:selected").val();
  ...
  $("#default_table").on("click", "a.edit-row", function () {
    ...
    $.ajax({
      ...
      success: function ({ data }) {
        ...
        var country_cv_ec = new Option(data.text_country_cv_ec, data.country_cv_ec, false, false);
        $('#form_edit select[name="country_cv_ec"]').append(country_cv_ec).trigger('change');
    
        $('#form_edit select[name="department_cv_ec"]').val(data.department_cv_ec);
        var department_cv_ec = new Option(data.text_department_cv_ec, data.department_cv_ec, false, false);
        $('#form_edit select[name="department_cv_ec"]').append(department_cv_ec).trigger('change');
    
        $('#form_edit select[name="city_cv_ec"]').val(data.city_cv_ec);
        var city_cv_ec = new Option(data.text_city_cv_ec, data.city_cv_ec, false, false);
        $('#form_edit select[name="city_cv_ec"]').append(city_cv_ec).trigger('change');
