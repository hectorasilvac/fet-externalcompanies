            ...
            **/            
            ...
            .then($.proxy(function () {
                ...
                if(this.input.error) {
                    ...
                    var value = (this.value === 'null' || this.value === null || this.value === undefined || this.value === '') ? this.options.defaultValue : this.value;
            ...
            */
            if(isEmpty !== undefined) { 
                ...
                if(typeof(this.input.isEmpty) === 'function') {
                    ...
                    this.isEmpty = $.trim(this.$element.html()) === '' || $.trim(this.$element.html()) === 'null';
                }
            }           
