        ...
        [
            {
                ...
                {
                    return '<br><br><div class="span-left"><span class="text-left" id="name_module" data-type="text" data-pk="' + row.id_module + '" data-url="' + $path_edit + '" data-value="' + data + '">' + data + '</span></div>';
                }
            },
            {
                targets: [1],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span class="text-left" id="name_es_module" data-type="text" data-pk="' + row.id_module + '" data-url="' + $path_edit + '" data-value="' + data + '">' + data + '</span></div>';
                }
            },
            {
                targets: [2],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span class="text-left" id="url_module" data-type="text" data-pk="' + row.id_module + '" data-url="' + $path_edit + '" data-value="' + data + '">' + data + '</span></div>';
                }
            },
            {
                targets: [3],
                ...
                render: function(data, type, row)
                {
                    return '<br><br><div class="span-left"><span class="text-left" id="icon_module" data-type="text" data-pk="' + row.id_module + '" data-url="' + $path_edit + '" data-value="' + data + '">' + data + '</span> <i class="' + data + '"></i></div>';
                }
            },
            {
                targets: [4],
                                ...
                                if ((old_value == '#' && value != null && value != '' && value != '#') || (old_value != '#' && old_value != '' && old_value != null && value == '#'))
                                {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response)
                                        {
                                            ...
                                            {
                                                message =  'Recuerde que si se cambia a una URL diferente de \'#\' los submodulos asociados serán eliminados y los permisos serán modificados, siendo una opción de menú directa' + users + '. Seguro que deseas ejecutar esta acción?';
                                                flag =  1;
                                            }
                                            else
                                            {
                                                message =  'Recuerde que si se cambia la URL a \'#\' se tendrán que agregar nuevos submodulos y permisos posteriormente, dejando de ser una opción directa del menú' + users + '. Seguro que deseas ejecutar esta acción?';
                                                flag =  2;
                                            }
